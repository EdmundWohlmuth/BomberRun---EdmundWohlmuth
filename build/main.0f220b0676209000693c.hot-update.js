...
class Bomb {
    ...
    update() {
        if (this.plane.state == Plane_1.Plane.STATE_DEAD ||
            ...
            return;
        if ((this.plane.sprite.x - this.bunker.x) && !createjs.Tween.hasActiveTweens(this._sprite)) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6acfcecf1d29b71ee21a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.0f220b0676209000693c.hot-update.js.map