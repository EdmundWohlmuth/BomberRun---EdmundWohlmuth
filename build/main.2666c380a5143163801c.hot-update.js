...
class AntiAir {
    ...
    startMe() {
        if (this._state == AntiAir.STATE_IDLE || this._state == AntiAir.STATE_SHOOTING) {
            this._state = AntiAir.STATE_MOVING;
            this._sprite.gotoAndPlay("AntiAir/move");
        }
    }
    stopMe() {
        if (this._state == AntiAir.STATE_MOVING || this._state == AntiAir.STATE_SHOOTING) {
            this._state = AntiAir.STATE_IDLE;
            this._sprite.gotoAndStop("AntiAir/move");
        }
    }
    shootMe() {
        this._state = AntiAir.STATE_SHOOTING;
        this._sprite.gotoAndPlay("AntiAir/shoot");
    }
    positionMe(x, y) {
        this._sprite.x = x;
        this._sprite.y = y;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("abae5654e39a4e071792")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.2666c380a5143163801c.hot-update.js.map