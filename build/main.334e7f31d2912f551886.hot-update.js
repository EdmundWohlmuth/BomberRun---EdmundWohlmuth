...
class Bullet {
    ...
    ShootMe() {
        if (this._state == Bullet.STATE_IDLE) {
            ...
            this.sprite.x = this.antiAir.sprite.x + 25;
            this.sprite.y = this.antiAir.sprite.y + 36;
        }
    }
    KillMe() {
        this._sprite.stop();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("58e62852cd4144fd516f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.334e7f31d2912f551886.hot-update.js.map