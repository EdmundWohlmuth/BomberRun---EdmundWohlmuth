...
class Bullet {
    ...
    ShootMe() {
        if (this._state == Bullet.STATE_IDLE) {
            this._sprite.x = this.antiAir.sprite.x + 57;
            this._sprite.y = this.antiAir.sprite.y + 100;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("88554d60001706ddde31")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.5a2face63f55f2953ec2.hot-update.js.map