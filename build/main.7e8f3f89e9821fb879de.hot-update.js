...
class Bullet {
    ...
    ShootMe() {
        if (this._state == Bullet.STATE_IDLE) {
            ...
            this._sprite.x = this.antiAir.sprite.x + 0;
            this._sprite.y = this.antiAir.sprite.y + 10;
        }
    }
    KillMe() {
        this._sprite.stop();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bcbd864700adb124c0cd")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.7e8f3f89e9821fb879de.hot-update.js.map