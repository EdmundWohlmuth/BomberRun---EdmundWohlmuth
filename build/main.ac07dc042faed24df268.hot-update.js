...
class Bullet {
    ...
    ShootMe() {
        if (this._state == Bullet.STATE_IDLE) {
            ...
            this._sprite.x = this.antiAir.sprite.x - 10;
            this._sprite.y = this.antiAir.sprite.y + 0;
        }
    }
    KillMe() {
        this._sprite.stop();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f01a8299799137201ea2")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.ac07dc042faed24df268.hot-update.js.map